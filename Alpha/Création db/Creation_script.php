    ...
    <body>
        <?php
            // Fichiers sources CSV analysés pour constituer les requêtes
                $source02="AUTOMATISE_GPS_thermometres_arbres.csv";
                $source03="AUTOMATISE_Relevés_thermometres.csv";
                $source04="AUTOMATISE_codes_arbres.txt";
                $source05="MANUEL_Arbres_releves_fructification.csv";
                $source06="MANUEL_Sangliers_comptage.csv";
                $source07="MANUEL_Sangliers_prelevements.csv";
                $source08="Temperature+vent.csv";
            ...
            // Fichiers de requêtes au format texte en SQL à générer
                ...
                $SQL03_5="SQL03_5_AUTOMATISE_heure_date.sql";
                ...
                echo "<h1 style='color:red'>Création des fichiers de requêtes SQL pour constituer la base de données</h1>";
            /////////////////////////////////////////////////////////////////////
            ///// Création Manuelle
            ///// --> TABLE DOMAINE
            ...
            echo "<span style='color:blue; font-size:150%'>",$sqlcomment,"</span><br/>";
            ...
            echo "<h2>Nombre de requêtes créées: <span style='color:green'>5</span></h2>";
            echo "<h2>Fichier de sortie créé: <span style='color:green'>$SQL01</span></h2><br/>";
            ...
            echo "<h2>Nombre de lignes traitées: <span style='color:blue'>$cpt</span></h2>";
            echo "<h2>Nombre de requêtes créées: <span style='color:green'>$req</span></h2>";
            echo "<h2>Fichier de sortie créé: <span style='color:green'>$SQL02</span></h2><br/>";
            ...
            echo "<h2>Nombre de lignes traitées: <span style='color:blue'>$cpt</span></h2>";
            echo "<h2>Nombre de requêtes créées: <span style='color:green'>$req</span></h2>";
            echo "<h2>Fichier de sortie créé: <span style='color:green'>$SQL03_5</span></h2><br/>";
            ...
            echo "<h2>Nombre de lignes traitées: <span style='color:blue'>$cpt</span></h2>";
            echo "<h2>Nombre de requêtes créées: <span style='color:green'>$req</span></h2>";
            echo "<h2>Fichier de sortie créé: <span style='color:green'>$SQL03</span></h2><br/>";
            ...
            echo "<h2>Nombre de lignes traitées: <span style='color:blue'>$cpt</span></h2>";
            echo "<h2>Nombre de requêtes créées: <span style='color:green'>$req</span></h2>";
            echo "<h2>Fichier de sortie créé: <span style='color:green'>$SQL04</span></h2><br/>";
            ...
            echo "<h2>Nombre de lignes traitées: <span style='color:blue'>$cpt</span></h2>";
            echo "<h2>Nombre de requêtes créées: <span style='color:green'>$req</span></h2>";
            echo "<h2>Fichier de sortie créé: <span style='color:green'>$SQL05</span></h2><br/>";
            ...
            echo "<h2>Nombre de lignes traitées: <span style='color:blue'>$cpt</span></h2>";
            echo "<h2>Nombre de requêtes créées: <span style='color:green'>$req</span></h2>";
            echo "<h2>Fichier de sortie créé: <span style='color:green'>$SQL06</span></h2><br/>";
            ...
            while (($data = fgetcsv($litThermo, 0, $sep)) !== FALSE) {
                ...
                $sql="INSERT INTO Donnees_externes(id_meteo,vent,temp) VALUES('$cpt','$Vent','$Temp');\r\n";
                fwrite($ecritSQL,$sql);
                $req++;

                $sql="INSERT INTO Date_donnees_externes(annee_mois) VALUES('$Annee_mois');\r\n";
                fwrite($ecritSQL,$sql);
                $req++;
